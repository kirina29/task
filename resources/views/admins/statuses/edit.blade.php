    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mx-auto">
                ...
                <form method="POST" action="{{route('statuses.update', $stts)}}"  class="adminFormAddTask">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="form-name">Название</label>
                        <input type="text" class="form-control block mt-1 w-full" value="{{$stts->name}}" name="name" id="form-name" placeholder="Название статуса">
                    </div>
